...
impl ChannelManager {
    ...
    pub async fn subscribe(
        ...
        tracing::debug!("Connection {} subscribed to topic: {}", connection_id, topic);
        Ok(())
    }
    ...
    pub async fn unsubscribe(
        ...
        tracing::debug!("Connection {} unsubscribed from topic: {}", connection_id, topic);
        Ok(())
    }
...
mod tests {
    ...
    async fn test_subscribe_unsubscribe() {
        ...
        manager.subscribe(conn_id, "test-topic", tx.clone()).await.unwrap();
    ...
    async fn test_disconnect_cleanup() {
        ...
        manager.subscribe(conn_id, "topic1", tx.clone()).await.unwrap();
